...
@InputType()
class AttendanceCreateNestedManyWithoutCoursesInput {
...
export { AttendanceCreateNestedManyWithoutCoursesInput as AttendanceCreateNestedManyWithoutCoursesInput };
